...
namespace vue.Models
{
    public partial class triangleContext : DbContext
    {
        ...
        public virtual DbSet<VacancyTest> VacancyTest { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VacancyTest>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("Vacancy_test");
                ...
                entity.Property(e => e.VacancyId).ValueGeneratedOnAdd();
